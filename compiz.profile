...
s0_spread_app_windows = Disabled
s0_spread_app_windows_anywhere = Disabled
...
s0_initiate_all_edge = 
s0_initiate_all_button = Disabled
s0_initiate_all_key = <Super>asciitilde
...
[core]
s0_active_plugins = core;composite;opengl;move;vpswitch;place;put;snap;copytex;commands;compiztoolbox;wall;grid;regex;mousepoll;imgpng;session;animation;fade;workarounds;scale;unitymtgrabhandles;expo;ezoom;unityshell;
